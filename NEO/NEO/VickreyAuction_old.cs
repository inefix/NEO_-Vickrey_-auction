...
namespace NEO
{
    public class VickreyAuction_old : SmartContract
    {
        ...
        public static Object Main(string method, params object[] args)
        {
            ...
            if (Runtime.Trigger == TriggerType.Application)
            {
                switch (method)
                {
                    ...
                    case "Init":
                        return Init((byte[])args[0], (int)args[1], (int)args[2], (int)args[3]);
                    case "Bid":
        ...
        private static bool Init(/*TODO : check type*/byte[] token, int reservePrice, int biddingPeriod, int revealingPeriod)
        {
